...
var addeventatc = function () {
    ...
    return {
        ...
        show: function (e, t) {
            var a, n, o, d, c, i, l, s, r, p, u, v, m, g, f = $d(e),
                h = $d(e + "-drop");
            f && h && ("block" == addeventatc.getstyle(h, "display") ? addeventatc.hideandreset() : (addeventatc.hideandreset(!0), h.style.display = "block", f.style.outline = "0", w = addeventatc.topzindex(), f.style.zIndex = w + 1, f.className = f.className.replace(/\s+/g, " "), f.setAttribute("aria-expanded", "true"), h.setAttribute("aria-hidden", "false"), t.keynav && addeventatc.keyboard(this, {
                ...
                id: e
            }), null != L && addeventatc.trigger("button_dropdown_show", {
                id: e
            })))
        },
        hide: function (e) {
        ...
        register: function (e, t) {
            "button-click" == e && (S = t), "button-mouseover" == e && (H = t), "button-mouseout" == e && (a = t), "button-dropdown-show" == e && (L = t), "button-dropdown-hide" == e && (R = t), "button-dropdown-click" == e && (M = t)
        },
        settings: function (e) {
        ...
        keyboard: function (e, t) {
            ...
            if (a && "block" == addeventatc.getstyle(a, "display")) {
                ...
                for (var l, i = d = 0; i < n.length; i += 1) ++d == c ? (n[i].className += " drop_markup", n[i].tabIndex = "0", n[i].focus()) : (l = new RegExp("(\\s|^)drop_markup(\\s|$)"), n[i].className = n[i].className.replace(l, " "), n[i].className = n[i].className.replace(/\s+$/, ""), n[i].tabIndex = "-1")
            }
        },
        ...
        usewebcal: function () {
            ...
            return (n && a || n && t) && (alert('If the event fails to load please \n"Open the page in Safari".'), e = !0), e
        },
        agent: function () {
